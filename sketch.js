...
p.preload = () => {
  p.map1s = p.loadImage('https://res.cloudinary.com/dkjgmeufk/image/upload/v1754468817/firstmap_zuxfed.jpg')
...
//  p.maxgridoffset = -2000;
 // collisionGrid = Array.from({ length: 10 }, () =>
  ...
  movingSquares.push(new MovingSquare(-16000-spawnx, -16000-spawny, 32000, p.map1s,p));
